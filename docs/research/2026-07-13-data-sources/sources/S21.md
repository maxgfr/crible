...
- backend: claude · fetched: 2026-07-13T10:08:02.933Z · trust: 0.8 · score: 0.0152
### Uh oh!
...
the SimFin server, saves the data to disk for
future use, and loads the data into Pandas DataFrames.
## Installation
pip install simfin
More detailed installation instructions can be found below .
## API-Key
To download data from SimFin you need an API-key, you can get one for free by registering on simfin.com . Once you registered, you can find your API-key here .
The free datasets contain less data than the paid SimFin+ datasets and some datasets are only available to SimFin+ users.
Visit SimFin for a comparison of the free and paid data versions.
## Example

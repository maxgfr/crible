...
|---|---|---|---|---|---|---|
| FR-001 | NFR-003, NFR-005, NFR-009, NFR-010 | 0001, 0003 | Company | CLI | Empty & Error States | — |
...
| FR-006 | NFR-001, NFR-002, NFR-008 | 0001, 0002 | SnapshotRow, Preset, Company | HTTP API | Status Dashboard, Feedback & Notifications | Ingest & coverage status |

...
Consolidate the test-plan results and the run logs into `evals/2026-07-14-c3/findings.json` following `evals/2026-07-14-c3/findings.schema.json`.
...
Also draft `evals/2026-07-14-c3/RESULTS.md` (per-functionality results, every claim citing `[F#]`) and `evals/2026-07-14-c3/SUMMARY.md` (scorecard + headline). Flag any narrative sentence that is not a finding with `[M]`.

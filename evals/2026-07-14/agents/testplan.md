...
Read `/Users/maxime/Downloads/crible` (its SKILL.md/README/CLI `--help`, or its source) and the research notes under `evals/2026-07-14/research/`.
...
Write `evals/2026-07-14/TEST-PLAN.md` (a reviewable checklist with the rubric embedded). Be exhaustive about the CLI/behavior surface.

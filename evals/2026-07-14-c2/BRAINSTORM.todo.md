...
- `src/crible/ingest/service.py` (large: 523 LOC, 20 commits (churn), nesting depth 11)
- `src/crible/ingest/enrichment.py` (large: 617 LOC, nesting depth 14)
- `src/crible/cli.py` (large: 341 LOC, 14 commits (churn))
- `src/crible/compute/snapshot.py` (large: 300 LOC, 12 commits (churn), nesting depth 8)
- `tests/test_fr010_esef.py` (large: 371 LOC, nesting depth 8)
- `ui/src/App.tsx` (275 LOC, 10 commits (churn), nesting depth 9)
- `tests/test_fr002_ingest.py` (295 LOC)
